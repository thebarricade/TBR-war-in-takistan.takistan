...
{ _x ctrlEnable false; } forEach [_transportUnitLb, _transportTaskLb, _casUnitLb, _casTaskLb, _artyUnitLb, _artyOrdnanceTypeLb, _artyRateOfFireLb, _artyRoundCountLb, _transportHeightCombo, _transportSpeedCombo, _transportRoeCombo];
{ lbClear _x } forEach [_transportUnitLb, _transportTaskLb, _casUnitLb, _casTaskLb, _artyUnitLb, _artyOrdnanceTypeLb, _artyRateOfFireLb, _artyRoundCountLb, _transportHeightCombo, _transportSpeedCombo, _transportRoeCombo];
...
switch (toUpper (_lb lbText _index)) do
{
	case "TRANSPORT" : 
	{
		...
		{
			_transportUnitText ctrlSetStructuredText parseText "<t color='#FFFFFF' size='0.8' font='Zeppelin33Italic'>UNIT</t>";
			_transportHelpUnitText ctrlSetStructuredText parseText "<t color='#FFFF00' size='0.7' font='Zeppelin33Italic'>Select a unit</t>";
			
			_transportConfirmButton ctrlEnable false; _transportConfirmButton ctrlSetPosition [safeZoneX + (safeZoneW / 3), safeZoneY + (safeZoneH / 1.425), (safeZoneW / 10), (safeZoneH / 20)]; _transportConfirmButton ctrlCommit 0;
			_transportBaseButton ctrlEnable false; _transportBaseButton ctrlSetPosition [safeZoneX + (safeZoneW / 3), safeZoneY + (safeZoneH / 1.375), (safeZoneW / 8), (safeZoneH / 20)]; _transportBaseButton ctrlCommit 0;
	...
	case "ARTY" :
	{
		...
		{
			_artyUnitText ctrlSetStructuredText parseText "<t color='#FFFFFF' size='0.8' font='Zeppelin33Italic'>BATTERY</t>";
			_artyHelpUnitText ctrlSetStructuredText parseText "<t color='#FFFF00' size='0.7' font='Zeppelin33Italic'>Select a unit</t>";
			
			_artyConfirmButton ctrlEnable false; _artyConfirmButton ctrlSetPosition [safeZoneX + (safeZoneW / 3), safeZoneY + (safeZoneH / 1.425), (safeZoneW / 10), (safeZoneH / 20)]; _artyConfirmButton ctrlCommit 0;
			_artyBaseButton ctrlEnable false; _artyBaseButton ctrlSetPosition [safeZoneX + (safeZoneW / 3), safeZoneY + (safeZoneH / 1.375), (safeZoneW / 8), (safeZoneH / 20)]; _artyBaseButton ctrlCommit 0;
