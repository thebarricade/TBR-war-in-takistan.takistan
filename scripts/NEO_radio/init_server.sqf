...

{
	...
	NEO_radioLogic setVariable [format ["NEO_radioTrasportArray_%1", _side], []];
	NEO_radioLogic setVariable [format ["NEO_radioCasArray_%1", _side], []];
	NEO_radioLogic setVariable [format ["NEO_radioArtyArray_%1", _side], []];
